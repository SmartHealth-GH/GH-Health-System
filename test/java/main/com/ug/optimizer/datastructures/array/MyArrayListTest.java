...
public class MyArrayListTest {
    ...
    private static void testResize() {
        ...
        assert list.getCapacity() == 4 : "Capacity should be 4 (doubled from 2)";
        ...
        assert list.getCapacity() == 8 : "Capacity should be 8";
        
        passed++;
        System.out.println("   ✅ Passed - Size: " + list.size() + ", Capacity: " + list.getCapacity());
    }
